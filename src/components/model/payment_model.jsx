...
const PaymentModal = ({ onClose }) => {
  ...
  const generatePdf = async () => {
    ...
    try {
      const logoBase64 = await getBase64FromUrl('https://raw.githubusercontent.com/munaziri123/t-roger/main/public/react.jpg');
      const signBase64 = await getBase64FromUrl('https://raw.githubusercontent.com/munaziri123/t-roger/main/public/signature.png');

      if (logoBase64) doc.addImage(logoBase64, 'JPEG', 150, 10, 40, 20);
      ...
      doc.text(`You have successfully registered as a Competitor in the category of "${category}".`, 20, 60);
      ...
      doc.text('Thank you for joining the T-Roger family. We look forward to your performance!', 20, 135, { maxWidth: 170 });

      doc.setFont('helvetica', 'bold');
      doc.text('Signed by:', 20, 160);
      doc.text('IRADUKUNDA Thierry Roger', 20, 170);
      if (signBase64) doc.addImage(signBase64, 'PNG', 20, 182, 50, 20);
      doc.setFont('helvetica', 'normal');
        ...
        {!showCongrats ? (
          <>
            ...
            <p className="modal-description">
              We are currently working hard to enable <strong>direct online payment</strong> on our platform. 🙏 Until then, please pay using the <strong>MTN MoMo code</strong> below.
            </p>
